                ...
                return (
                  ...
                  >
                    ...
                    {!isSelf && timingConflict && (
                      <span className="absolute top-0 right-0 w-full h-full opacity-50 bg-rose-600"></span>
                    )}
                    {!isSelf && sizeConflict && (
                      <span className="absolute top-0 right-0 w-full h-full opacity-50 bg-amber-200"></span>
                    )}
                  </td>
                );
              })}
